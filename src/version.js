...
//  build: 178bumped automatically with every commit by the git pre-commit hook (.git/hooks/pre-commit): it is the number of commits
//         including the one being made. (It also rewrites the ?v= of this file in index.html, so a browser never keeps an old copy.)
const GAME_VERSION = { major: 1, minor: 0, build: 178 };
